...
Выбор RandomForest обоснован:
1. Способность учета алгоритмом нелинейных зависимостей
2. Устойчивость к дисбалансу (class_weight='balanced')
...
class ModelTrainer:
    ...
    def __init__(self, model_params=None):
        ...
        self.default_params = {
            'n_estimators': 100,        # 100 деревьев - баланс качество/скорость
    ...
    def save_model(self, path='C:/Users/U_M1P8G/Desktop/IDE/Внедрение моделей ML/Сессионный проект/credit_card_ml_deployment/models/model.joblib'):
        """
        ...
        logger.info(f"Версия: v1")
        logger.info(f"Время: {datetime.now().isoformat()}")
    
    def save_metrics_json(self, path='C:/Users/U_M1P8G/Desktop/IDE/Внедрение моделей ML/Сессионный проект/credit_card_ml_deployment/models/metrics.json'):
        """
    ...
    def run_pipeline(self):
        ...
        # Шаг 6: Сохранение
        self.save_model('C:/Users/U_M1P8G/Desktop/IDE/Внедрение моделей ML/Сессионный проект/credit_card_ml_deployment/models/model.joblib')
        self.save_metrics_json('C:/Users/U_M1P8G/Desktop/IDE/Внедрение моделей ML/Сессионный проект/credit_card_ml_deployment/models/metrics.json')
